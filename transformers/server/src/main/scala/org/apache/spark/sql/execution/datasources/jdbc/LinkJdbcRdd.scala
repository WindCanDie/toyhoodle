...
//}
//
//private[sql] object LinkJdbcRdd extends Logging {
//
//  /**
...
//  */
//class LinkJdbcRdd( sc: SparkContext,
...
//                   url: String,
//                   properties: Properties) extends RDD[InternalRow](sc, Nil) {
//
...
//    filters.flatMap(LinkJdbcRdd.compileFilter).map(p => s"($p)").mkString(" AND ")
//
//  /**
